fn main() {
    ...
    let (product_of_nums, numbers2) = product(numbers1); // 👉 TODO call product() and put answer here
    let (average_of_nums, _) = average(numbers2); // 👉 TODO call average() and put answer here
